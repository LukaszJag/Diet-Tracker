package com.lukaszjag.diet_tracker_android.tools.date_tools;
...
public class MyDate {
    public static final Date dateLocal = new Date();
    ...
    public static int getCurrentMonthNumber() {
        return Integer.valueOf(new SimpleDateFormat("MM").format(dateLocal));
    }

    public static String getCurrentMonthName() {
        return new SimpleDateFormat("MMMM").format(dateLocal);
    }

    public static int getCurrentYear() {
        return Integer.valueOf(new SimpleDateFormat("yyyy").format(dateLocal));
    }
    ...
    public static String[] getAllDaysForCurrentMonthInSQLFriendlyFormat() {
        int monthInt = Integer.valueOf(new SimpleDateFormat("MM").format(dateLocal));
        String firstPartOfResult = new SimpleDateFormat("yyyy-MM").format(dateLocal);
