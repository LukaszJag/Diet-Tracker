...
public class Notes extends AppCompatActivity {
    ...
    private void populateDummyData() {
        ...
        adapter.addItem(new Note("BitWarden Config", "Skonfigurowa� BitWardena", "Za�o�y� konto, ustawi� has�o, doda� kilka hase�", "Security", "High-Stakes Campaign", false, true, false, null, today, ""));
        adapter.addItem(new Note("Bookshelf Sort", "Doda� kategorie do ksi��ek na p�ce", "Przeniesienie bazy do serwisu lubimyczyta�.pl", "Organize", "no urgent scale", false, false, false, null, today, ""));
        adapter.addItem(new Note("Savings Goal", "Wyznaczy� kwote do od�o�enia na monitor", "Znale�� konkretny model do kupienia i od�o�y� bud�et", "Financial", "Strategic Initiative", false, true, true, null, today, "2026-12-31"));
    }
}
