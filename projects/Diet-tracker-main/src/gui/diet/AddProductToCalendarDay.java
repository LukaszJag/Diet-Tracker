...
public class AddProductToCalendarDay {
    ...
    private void addComponentsToWestPanel() {
        ...
        String dateForCheckDaysDStatisticsTable = addProductToDayDisplaySelectedFDateDayLabel.getText().substring(0, 5) + "07%";
...
*/
    ...
    private class EditDaysStatisticsFileButtonActionListener implements ActionListener {
        ...
        private void setDataForTable() {
            ...
            pathToFile = "F:\\Linux-Windows-Files\\1-learning\\1-Java-Ecosystem\\1-Projects\\Diet_Tracker\\Diet-Tracker\\projects\\Diet-tracker-main\\src" + "/data_store_and_backup/text_files/days_statistics_test/" +
        ...
        private void updateTable() {
            ...
            // TODO hard coded value "2026-07%" - need to set general value
